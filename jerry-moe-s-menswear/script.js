/* ============================================================
   Jerry Moe's Menswear  -  interactions
   - Sticky header transition on scroll
   - Scroll reveal (fade + rise), staggered
   - Reveal-on-load safety: anything in view on load shows
     immediately, and a window 'load' fallback reveals the rest
   - Subtle hero scale settle on load
...
(function () {
  ...
  if (prefersReduced || !("IntersectionObserver" in window)) {
    ...
    // hidden (covers any element the observer somehow missed).
